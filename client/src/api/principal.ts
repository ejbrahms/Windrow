 ...
 * (server/principals/) — prefer that over the loom/role name everywhere a principal is shown.
...
/** Groups instance principals by display name — a human who has been spawned into several loom
 * ids (a respawn, a new session) otherwise shows up as one row/button per loom, repeating the
